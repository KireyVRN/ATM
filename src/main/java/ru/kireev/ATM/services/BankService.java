...
//        Role client = roleRepository.save(new Role().setName("CLIENT"));
//
...
//
//        clientRepository.save(new Client().setName("Василий").addCard(card1).addCard(card2).setRoles(List.of(client)).setPassword("$2y$12$LM54AZMFGb1DLPwzN5oOI.GgagLLIAOCgxNvTaEGgEuhYGCvEHSMK"));
//        clientRepository.save(new Client().setName("Мария").addCard(card3).addCard(card4).setRoles(List.of(client)).setPassword("$2y$12$yHdz9NBu8LSR1w0M209w1Ok9SMASLWL9KQ74EHcPwYTMqGsx2go7i"));
//        clientRepository.save(new Client().setName("Jhon").addCard(card5).addCard(card6).addCard(card7).addCard(card8).setRoles(List.of(client)).setPassword("$2y$12$Fgmr5AXTgQ8PJzx4zWnYJOa0pe5wJspFvMjA1x0aUIaVZsTDCfJoK"));
//        clientRepository.save(new Client().setName("Яша").addCard(card9).setRoles(List.of(client)).setPassword("$2y$12$CqleceekK9A2I2GtEyqNrez0TDSbg2nFAkD6N2Ox/8BO3elzJZOm2"));
//
